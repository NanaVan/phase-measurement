...
import sip
import step_a_1_epy_block_0 as epy_block_0  # embedded python block



class step_a_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "step_a_1")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 34000
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 2200, 1, 0, 0)
...
def main(top_block_cls=step_a_1, options=None):
