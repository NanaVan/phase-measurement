...
import sip
import step_a_epy_block_0 as epy_block_0  # embedded python block



class step_a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "step_a")
...
def main(top_block_cls=step_a, options=None):
