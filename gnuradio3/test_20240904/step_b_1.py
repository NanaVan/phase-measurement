...
import numpy as np
import sip
import step_b_1_bin_select as bin_select  # embedded python module



class step_b_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "step_b_1")
        ...
        self.tabs.addTab(self.tabs_widget_2, 'Phase/bin')
        ...
        self.qtgui_waterfall_sink_x_0.set_intensity_range(0, 240)
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            256, #size
            samp_rate/point_size, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.tabs_grid_layout_2.addWidget(self._qtgui_time_sink_x_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        self.tabs_grid_layout_2.addWidget(self._qtgui_time_raster_sink_x_0_0_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.tabs_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tabs_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.qtgui_time_raster_sink_x_0.set_intensity_range(0, 2e9)
        ...
        self.qtgui_freq_sink_x_0.set_y_axis((-80), 150)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(np.exp(1j * phase_delay))
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, bin_select.select_binNum(samp_rate, point_size, bin_freq))
        ...
        self.connect((self.blocks_complex_to_magphase_0, 1), (self.blocks_delay_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.x_correlation_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_delay_0.set_dly(int(bin_select.select_binNum(self.samp_rate, self.point_size, self.bin_freq)))
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/self.point_size)
    ...
    def set_point_size(self, point_size):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/self.point_size)
        self.x_correlation_0.set_point_size(self.point_size)
    ...
    def set_phase_delay(self, phase_delay):
        ...
        self.blocks_multiply_const_vxx_1.set_k(np.exp(1j * self.phase_delay))
...
def main(top_block_cls=step_b_1, options=None):
